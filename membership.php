...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body >
		<div id="body_wrapper">
			<header id="header">
				<a href="index.html"><img id="logo" src="icons/gmhotspot web LOGO.png" alt="logo"/></a>
				<a href="index.html"><img id="banner" src="icons/gmhotspot web banner.png" alt="logo"/></a>
			...
			<main>
				<section id="main_others"style="background-image: url(Images/solid.png);">
