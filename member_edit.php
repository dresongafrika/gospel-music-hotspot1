...
echo'
        <div class="wrapper">
            ...
            <div class="form-group">
                ...
                <select type="date" name="country" class="form-control">
                <option type="date" name="male" class="form-control">Male</option>
                <option type="date" name="female" class="form-control">Female</option>
                </select>
                <span class="help-block"> '. $sex_err.'</span>
            </div>
            <div class="form-group">
                <label>Country of Origin:<sup>*</sup></label>
                <input type="date" name="country" class="form-control" value="'. $country.'">
